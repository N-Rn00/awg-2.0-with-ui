...
const getRandomHex = () => {
  const bytes = Math.floor(Math.random() * 96) + 32;
...
// AmneziaWG 2.0 NEW parameters
module.exports.S3 = process.env.S3 || getRandomJunkSize();
module.exports.S4 = process.env.S4 || getRandomJunkSize();
module.exports.I1 = process.env.I1 || getRandomHex();
module.exports.I2 = process.env.I2 || getRandomHex();
module.exports.I3 = process.env.I3 || getRandomHex();
module.exports.I4 = process.env.I4 || getRandomHex();
module.exports.I5 = process.env.I5 || getRandomHex();
